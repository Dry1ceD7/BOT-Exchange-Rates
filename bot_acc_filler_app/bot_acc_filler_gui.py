...
class FillerApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(header, text="🏦  BOT Exchange Rate Filler",
                     font=ctk.CTkFont(size=22, weight="bold")).pack(side="left")
        ctk.CTkLabel(header, text="v2.0", font=ctk.CTkFont(size=12),
        ...
        self.file_label = ctk.CTkLabel(
            drop_frame, text="📂  Click to select an Excel file (.xlsx)",
            font=ctk.CTkFont(size=14), text_color="#93C5FD", cursor="hand2")
        ...
        self.run_btn = ctk.CTkButton(
            btn_frame, text="▶  Fill Rates", font=ctk.CTkFont(size=14, weight="bold"),
            height=42, corner_radius=8, fg_color="#2563EB", hover_color="#1D4ED8",
            command=self._start_fill, state="disabled")
        self.run_btn.pack(side="left", expand=True, fill="x", padx=(0, 5))
        self.open_btn = ctk.CTkButton(
            btn_frame, text="📁  Open Output", font=ctk.CTkFont(size=14),
            height=42, corner_radius=8, fg_color="#059669", hover_color="#047857",
        ...
        self.status_label = ctk.CTkLabel(
            self, text="Ready — select an Excel file to begin",
    ...
    def _pick_file(self, event=None):
        ...
        if path:
            ...
            self.file_label.configure(text=f"📄  {os.path.basename(path)}", text_color="#60A5FA")
